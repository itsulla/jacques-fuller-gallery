...
Create a permanent online gallery for Jacques Fuller, a Bloemfontein-based sculptor active since 1989. The site presents 57 photographed sculptures plus one explicitly labelled Jewellery collection in more depth than Facebook can, with related images grouped into coherent records.
...
- Responsive web gallery with 58 current records and 375 photographs.
...
- The source library contains 58 current-record folders: 57 sculptures and one Jewellery collection.
